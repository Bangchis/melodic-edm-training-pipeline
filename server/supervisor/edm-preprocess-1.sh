...
exec .venv/bin/python -u -m acestep.training_v2.cli.train_fixed \
  --preprocess \
  --audio-dir /workspace/melodic_edm_training_pipeline/data/final_dataset_part1 \
  --dataset-json /workspace/melodic_edm_training_pipeline/data/dataset_train_part1.json \
  --tensor-output /workspace/melodic_edm_training_pipeline/data/tensors_part1 \
