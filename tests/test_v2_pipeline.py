...
"""
    ...
    def test_colab_exposes_sampling_lora_and_optional_enhancer_in_one_cell(self) -> None:
        ...
        self.assertIn("DURATION_SECONDS = 232", controls[0])
        ...
        self.assertIn("ADAPTER_CHOICE = 'experimental-r32'", controls[0])
        self.assertIn("USE_LORA = True", controls[0])
        self.assertIn("LORA_SCALE = 0.5", controls[0])
        self.assertIn("GUIDANCE_SCALE = 9.0", controls[0])
        ...
        self.assertIn("KEYSCALE = 'A minor'", controls[0])
        self.assertIn("Oriental progressive house", controls[0])
        self.assertIn("First Progressive-House Drop", controls[0])
        self.assertIn("USE_ACE_LM_THINKING = True", controls[0])
        self.assertIn("ACE_LM_MODEL = 'acestep-5Hz-lm-4B'", controls[0])
        self.assertIn("LM_TEMPERATURE = 0.3", controls[0])
        ...
        self.assertIn("descriptive section labels are not limited to 80 characters", payload_builder)
        self.assertIn("prompt_enhancer_module.sections_to_lyrics = sections_to_lyrics", payload_builder)
        self.assertIn("music_conditions['lyrics'] = STRUCTURE_LYRICS", payload_builder)
        self.assertIn("repo_id=ace_lm_repo, revision=ACE_LM_REVISION", payload_builder)
